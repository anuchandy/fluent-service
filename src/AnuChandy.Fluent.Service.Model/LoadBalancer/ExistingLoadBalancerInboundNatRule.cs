...
{
    public class ExistingLoadBalancerInboundNatRule
    {
        [JsonProperty(PropertyName = "existingLoadBalancer")]
        public ExistingLoadBalancer ExistingLoadBalancer { get; set; }

        [JsonProperty(PropertyName = "natRuleNames")]
        public IList<String> NatRuleNames { get; set; }
        ...
        public void Validate(String propertyName)
        {
            ...
            if (this.NatRuleNames == null || NatRuleNames.Count == 0)
            {
                throw new ArgumentException($"{propertyName} specified but required {propertyName}.NatRuleNames is not specified");
            }
        }
    ...
    public class ExistingLoadBalancerInboundNatRules 
        : List<ExistingLoadBalancerInboundNatRule>, ISupportsValidateAndResolve
    {
