...
{
    public class ExistingNetworkInterface
        : ExistingGroupableResource<INetworkInterfaces, INetworkInterface>
    {
        public override Task ResolveResourceAsync(IAzure azure, CancellationToken cancellationToken = default(CancellationToken))
        {
            return base.ResolveResourceAsync(azure.NetworkInterfaces, cancellationToken);
        }
    }
}
